            ...
            <table width="100%"
                ...
                <tr>
                    <td class="text" style="text-align: center;">
                        Bald ist es soweit – deine frischgebackenen Pizzas freuen sich darauf, aus der Tiefkühltruhe
                        befreit zu werden und dich kennenzulernen.
                    </td>
                </tr>
                <tr>
                    <td height="40">&nbsp;</td>
                ...
                <tr>
                    <td class="text" style="text-align: center;">
                        Zur Erinnerung: Am {{$date}} zwischen {{$time_from}} - {{$time_to}} treffen die Pizzas bei dir
                ...
                <tr>
                    <td class="text" style="text-align: center;">
                        Ciao ciao – und bis in einem Monat wieder.<br>
                        Dein DIO/MIO-Team
                    </td>
